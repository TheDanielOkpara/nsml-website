...
<table>
  ...
  <?php foreach ($rows as $m): ?>
    <tr>
      <td><?php if ($m['photo']): ?><img class="thumb" src="<?= htmlspecialchars(asset_url($m['photo'])) ?>" alt=""><?php else: ?><div class="thumb" style="display:flex;align-items:center;justify-content:center;color:var(--text-muted);font-size:0.6875rem;">No photo</div><?php endif; ?></td>
