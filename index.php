...
<head>
  ...
  <style>
    ...
    /* Crop to athletes on the right — hides the brand image text on the left */
    .hero-bg {
      position: absolute;
      inset: 0;
      width: 100%;
    ...
    /* Dark gradient from left — keeps text readable, fades to reveal athletes on right */
    .hero-overlay {
      position: absolute;
      inset: 0;
      background:
        linear-gradient(to right,
          rgba(13,31,60,1)    0%,
          rgba(13,31,60,0.97) 30%,
          rgba(13,31,60,0.7)  55%,
          rgba(13,31,60,0.2)  80%,
          rgba(13,31,60,0.08) 100%),
        linear-gradient(to bottom,
          rgba(13,31,60,0.6) 0%,
          transparent 20%,
          transparent 80%,
          rgba(13,31,60,0.8) 100%);
    }
    ...
    /* Text lives in the left half — clean dark zone */
    .hero-content {
      max-width: 52rem;
    }
    ...
    .metric:hover {
      ...
      box-shadow: 0 4px 20px rgba(26,184,60,0.1);
    }
    ...
    /* ── STATS STRIP ─────────────────────────── */
    /* Handled by .stats-strip in styles.css */
    ...
    /* Large featured card: Lagos Marathon spans 2 cols */
    .feat-grid .prop-card-lg {
      grid-column: span 2;
      display: flex;
    ...
    .prop-card:hover {
      border-color: var(--green);
      box-shadow: 0 8px 32px rgba(26,184,60,0.12);
    ...
    .cta-band-bg {
      position: absolute;
      inset: 0;
      background: url('images/brand-hero.jpg') 70% center / cover no-repeat;
      opacity: 0.12;
    }
    ...
    .home-news-card:hover {
      border-color: var(--green);
      box-shadow: 0 6px 24px rgba(26,184,60,0.1);
      transform: translateY(-3px);
    }
...
<body>
  ...
  <!-- ── HERO ─────────────────────────────── -->
  <section class="hero">
    <video class="hero-bg" id="heroBg" autoplay muted loop playsinline poster="images/brand-hero.jpg">
    ...
    <div class="hero-inner">
      <div class="hero-content">
        ...
        <h1 class="hero-h1">
          ...
          <span class="hero-line" id="hl2">Force in <span class="hi">Sports</span></span>
        </h1>
        <p class="hero-p" id="heroP">
          Sports marketing, brand management and procurement that elevates athletes, brands and communities from grassroots to global recognition.
        </p>
  ...
  <div class="photo-slider">
    <div class="photo-slider-track">
      <div class="photo-slider-set">
        <div class="photo-slide"><img src="images/slider/slider-01.jpg" alt="NSML event moment" loading="lazy"></div>
        <div class="photo-slide"><img src="images/slider/slider-02.jpg" alt="NSML event moment" loading="lazy"></div>
        <div class="photo-slide"><img src="images/slider/slider-03.jpg" alt="NSML event moment" loading="lazy"></div>
        <div class="photo-slide"><img src="images/slider/slider-04.jpg" alt="NSML event moment" loading="lazy"></div>
        <div class="photo-slide"><img src="images/slider/slider-05.jpg" alt="NSML event moment" loading="lazy"></div>
        <div class="photo-slide"><img src="images/slider/slider-06.jpg" alt="NSML event moment" loading="lazy"></div>
        <div class="photo-slide"><img src="images/slider/slider-07.jpg" alt="NSML event moment" loading="lazy"></div>
        <div class="photo-slide"><img src="images/slider/slider-08.jpg" alt="NSML event moment" loading="lazy"></div>
        <div class="photo-slide"><img src="images/slider/slider-09.jpg" alt="NSML event moment" loading="lazy"></div>
        <div class="photo-slide"><img src="images/slider/slider-10.jpg" alt="NSML event moment" loading="lazy"></div>
        <div class="photo-slide"><img src="images/slider/slider-11.jpg" alt="NSML event moment" loading="lazy"></div>
        <div class="photo-slide"><img src="images/slider/slider-12.jpg" alt="NSML event moment" loading="lazy"></div>
        <div class="photo-slide"><img src="images/slider/slider-13.jpg" alt="NSML event moment" loading="lazy"></div>
        <div class="photo-slide"><img src="images/slider/slider-14.jpg" alt="NSML event moment" loading="lazy"></div>
      </div>
      <div class="photo-slider-set" aria-hidden="true">
        <div class="photo-slide"><img src="images/slider/slider-01.jpg" alt="" loading="lazy"></div>
        <div class="photo-slide"><img src="images/slider/slider-02.jpg" alt="" loading="lazy"></div>
        <div class="photo-slide"><img src="images/slider/slider-03.jpg" alt="" loading="lazy"></div>
        <div class="photo-slide"><img src="images/slider/slider-04.jpg" alt="" loading="lazy"></div>
        <div class="photo-slide"><img src="images/slider/slider-05.jpg" alt="" loading="lazy"></div>
        <div class="photo-slide"><img src="images/slider/slider-06.jpg" alt="" loading="lazy"></div>
        <div class="photo-slide"><img src="images/slider/slider-07.jpg" alt="" loading="lazy"></div>
        <div class="photo-slide"><img src="images/slider/slider-08.jpg" alt="" loading="lazy"></div>
        <div class="photo-slide"><img src="images/slider/slider-09.jpg" alt="" loading="lazy"></div>
        <div class="photo-slide"><img src="images/slider/slider-10.jpg" alt="" loading="lazy"></div>
        <div class="photo-slide"><img src="images/slider/slider-11.jpg" alt="" loading="lazy"></div>
        <div class="photo-slide"><img src="images/slider/slider-12.jpg" alt="" loading="lazy"></div>
        <div class="photo-slide"><img src="images/slider/slider-13.jpg" alt="" loading="lazy"></div>
        <div class="photo-slide"><img src="images/slider/slider-14.jpg" alt="" loading="lazy"></div>
      </div>
    </div>
  </div>
      ...
      <div class="teaser-metrics">
        <div class="metric">
          <div class="metric-inner">
            <div class="metric-val">700K<span class="metric-accent">+</span></div>
            <div class="metric-lbl">Participants across all events</div>
          </div>
        </div>
        <div class="metric">
          <div class="metric-inner">
            <div class="metric-val">₦4B<span class="metric-accent">+</span></div>
            <div class="metric-lbl">Raised annually from private sector</div>
          </div>
        </div>
        <div class="metric">
          <div class="metric-inner">
            <div class="metric-val">12<span class="metric-accent">+</span></div>
            <div class="metric-lbl">Major sporting properties managed</div>
          </div>
        </div>
        <div class="metric">
          <div class="metric-inner">
            <div class="metric-val">54</div>
            <div class="metric-lbl">African nations reached through events</div>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="stats-strip">
    <div class="stats-inner">
      <div class="stat" data-count="11" data-suffix="+ Yrs">
        ...
        <div class="stat-lbl">Years delivering world-class sports events</div>
      </div>
      <div class="stat" data-count="70" data-suffix="+">
        <div class="stat-val"><span class="count-num">0</span><span class="stat-suffix">+</span></div>
        <div class="stat-lbl">National and global brand partners</div>
      </div>
      <div class="stat" data-count="20000" data-suffix="+">
        <div class="stat-val"><span class="count-num">0</span><span class="stat-suffix">+</span></div>
        <div class="stat-lbl">Athletes at single-event peak</div>
      </div>
      <div class="stat" data-count="8" data-suffix=" Cities">
        ...
        <div class="stat-lbl">Active event footprint across Nigeria</div>
      </div>
    </div>
  </div>
    ...
    <div class="feat-section-inner">
      <div class="split-header">
        <div>
          ...
          <h2 class="sec-h2">Flagship <span class="hi">Events</span></h2>
        </div>
        <a href="properties" class="btn btn-outline btn-sm">View All</a>
      </div>
      <div class="feat-grid">
        ...
        <div style="display:flex;flex-direction:column;gap:1.25rem;">
          <div class="prop-card" data-reveal>
            <div class="prop-img-wrap">
              <img class="prop-img" src="images/events/abeokuta-hero.jpg" alt="Abeokuta 10KM Race" loading="lazy">
            </div>
            <div class="prop-body">
              ...
              <a href="abeokuta-race" class="btn btn-fill btn-sm">
                <span>View Property</span>
                <span class="btn-icon">↗</span>
              </a>
            </div>
          ...
          <div class="prop-card" data-reveal>
            <div class="prop-img-wrap">
              <img class="prop-img" src="images/events/abuja-hero.jpg" alt="PremiumTrust Bank Abuja City Marathon" loading="lazy">
            </div>
            <div class="prop-body">
  ...
  <div class="section-wrap">
    <div class="split-header">
      <div>
        ...
        <h2 class="sec-h2">From the <span class="hi">Frontlines</span></h2>
      </div>
    ...
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:1.25rem;" id="homeNewsGrid">
      ...
      <a href="/ceo-of-nilayo-sports-management-limited-mrs-yetunde-olopade-wins-prestigious-newstap-swan-5-star-award" class="home-news-card" data-reveal>
        <div style="overflow:hidden;height:190px;border-radius:var(--r-lg) var(--r-lg) 0 0;">
          <img src="images/news/WhatsApp-Image-2026-03-09-at-09.47.07.jpeg"
               alt="CEO of Nilayo Sports Management Limited, Mrs. Yetunde Olopade, Wins Prestigious Newstap/SWAN 5-Star Award" loading="lazy"
        ...
        <div style="padding:1.375rem;">
          <div style="display:flex;align-items:center;gap:0.625rem;margin-bottom:0.875rem;">
            <span style="background:var(--accent-glow);color:var(--green-dark);border:1px solid var(--accent-ring);border-radius:9999px;font-size:0.5875rem;font-weight:700;letter-spacing:0.12em;text-transform:uppercase;padding:0.2rem 0.75rem;">News</span>
            <span style="font-size:0.8125rem;color:var(--text-muted);">March 2026</span>
          </div>
          <div style="font-family:var(--font-d);font-size:1rem;font-weight:700;letter-spacing:-0.02em;line-height:1.3;color:var(--navy);margin-bottom:0.625rem;display:-webkit-box;-webkit-line-clamp:3;-webkit-box-orient:vertical;overflow:hidden;">CEO of Nilayo Sports Management Limited, Mrs. Yetunde Olopade, Wins Prestigious Newstap/SWAN 5-Star Award</div>
          <span style="font-size:0.875rem;font-weight:600;color:var(--green-dark);display:inline-flex;align-items:center;gap:0.375rem;transition:gap 0.3s;">Read More <span style="transition:transform 0.3s;">↗</span></span>
        </div>
      </a>

      <a href="/bayelsa-state-government-and-nilayo-sports-management-limited-announce-the-inaugural-yenagoa-city-international-10km-race" class="home-news-card" data-reveal>
        <div style="overflow:hidden;height:190px;border-radius:var(--r-lg) var(--r-lg) 0 0;">
          <img src="images/news/sport-c4.jpg-scaled.jpeg"
               alt="Bayelsa State Government and Nilayo Sports Management Limited Announce the Inaugural Yenagoa City International 10KM Race" loading="lazy"
               style="width:100%;height:100%;object-fit:cover;display:block;filter:contrast(1.06) brightness(0.97);transition:transform 0.7s cubic-bezier(0.32,0.72,0,1),filter 0.7s cubic-bezier(0.32,0.72,0,1);">
        </div>
        <div style="padding:1.375rem;">
          <div style="display:flex;align-items:center;gap:0.625rem;margin-bottom:0.875rem;">
          ...
          <div style="font-family:var(--font-d);font-size:1rem;font-weight:700;letter-spacing:-0.02em;line-height:1.3;color:var(--navy);margin-bottom:0.625rem;display:-webkit-box;-webkit-line-clamp:3;-webkit-box-orient:vertical;overflow:hidden;">Bayelsa State Government and Nilayo Sports Management Limited Announce the Inaugural Yenagoa City International 10KM Race</div>
          <span style="font-size:0.875rem;font-weight:600;color:var(--green-dark);display:inline-flex;align-items:center;gap:0.375rem;transition:gap 0.3s;">Read More <span style="transition:transform 0.3s;">↗</span></span>
        </div>
      </a>

      <a href="/nilayo-sports-management-md-chief-yetunde-olopade-named-among-2025-top-50-most-influential-african-women-in-sports" class="home-news-card" data-reveal>
        <div style="overflow:hidden;height:190px;border-radius:var(--r-lg) var(--r-lg) 0 0;">
          <img src="images/news/WhatsApp-Image-2025-11-21-at-13.15.09.jpeg"
               alt="Nilayo Sports Management MD, Chief Yetunde Olopade Named Among 2025 Top 50 Most Influential African Women in Sports" loading="lazy"
               style="width:100%;height:100%;object-fit:cover;display:block;filter:contrast(1.06) brightness(0.97);transition:transform 0.7s cubic-bezier(0.32,0.72,0,1),filter 0.7s cubic-bezier(0.32,0.72,0,1);">
        </div>
        <div style="padding:1.375rem;">
          <div style="display:flex;align-items:center;gap:0.625rem;margin-bottom:0.875rem;">
            <span style="background:var(--accent-glow);color:var(--green-dark);border:1px solid var(--accent-ring);border-radius:9999px;font-size:0.5875rem;font-weight:700;letter-spacing:0.12em;text-transform:uppercase;padding:0.2rem 0.75rem;">News</span>
            <span style="font-size:0.8125rem;color:var(--text-muted);">November 2025</span>
          </div>
          <div style="font-family:var(--font-d);font-size:1rem;font-weight:700;letter-spacing:-0.02em;line-height:1.3;color:var(--navy);margin-bottom:0.625rem;display:-webkit-box;-webkit-line-clamp:3;-webkit-box-orient:vertical;overflow:hidden;">Nilayo Sports Management MD, Chief Yetunde Olopade Named Among 2025 Top 50 Most Influential African Women in Sports</div>
          <span style="font-size:0.875rem;font-weight:600;color:var(--green-dark);display:inline-flex;align-items:center;gap:0.375rem;transition:gap 0.3s;">Read More <span style="transition:transform 0.3s;">↗</span></span>
        </div>
      </a>
  ...
  <div class="cta-band">
    ...
    <div class="cta-band-inner">
      <div data-reveal>
        <h2>Ready to build something <em>legendary</em> together?</h2>
        <p>When you partner with NSML, your brand connects with millions of athletes, fans, and communities across Africa. More than visibility — your brand stands alongside inspiring stories of people pushing limits.</p>
      </div>
      <div class="cta-band-btns" data-reveal>
        ...
        <a href="services" class="btn-ghost-white">Our Services</a>
      </div>
    </div>
  </div>
  ...
  <script>
    ...
    const io = new IntersectionObserver((entries) => {
      entries.forEach((entry, i) => {
        ...
        const delay = i * 90;
        setTimeout(() => {
          el.style.transition = `opacity 0.75s cubic-bezier(0.32,0.72,0,1) ${delay}ms,
    ...
    const statIo = new IntersectionObserver((entries) => {
      entries.forEach(entry => {
        ...
        el.style.transition = 'opacity 0.7s cubic-bezier(0.32,0.72,0,1), transform 0.7s cubic-bezier(0.32,0.72,0,1)';
        el.style.opacity    = '1';
        el.style.transform  = 'none';
