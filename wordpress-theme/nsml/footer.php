	...
	<footer>
		<div class="footer-inner">
			<div class="footer-top">
				<div>
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="f-logo">
						<img src="<?php echo esc_url( NSML_THEME_URI . '/assets/images/logo.png' ); ?>" alt="<?php esc_attr_e( 'Nilayo Sports Management Ltd', 'nsml' ); ?>" class="f-logo-img">
					</a>
					<div class="f-tagline"><?php esc_html_e( "Africa's leading sports marketing, brand management and procurement agency. World Athletics Certified. Home of the Access Bank Lagos City Marathon.", 'nsml' ); ?></div>
				</div>
			...
			<div class="footer-bottom">
				<div class="f-copy">&copy; <?php echo esc_html( gmdate( 'Y' ) ); ?> <?php esc_html_e( 'Nilayo Sports Management Ltd. All rights reserved.', 'nsml' ); ?></div>
				<a href="http://designthngs.com/" target="_blank" rel="noopener" class="f-credit"><?php esc_html_e( 'Built by Design Things Studio', 'nsml' ); ?></a>
				<div class="f-cert-pill"><span class="eyebrow-dot"></span><?php esc_html_e( 'World Athletics Certified 2025', 'nsml' ); ?></div>
			</div>
		</div>
	</footer>
